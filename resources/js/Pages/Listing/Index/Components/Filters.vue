...
<form @submit.prevent="filter">
    <div class="mb-4 mt-8 flex flex-wrap gap-2">
        <div class="flex flex-wrap items-center">
            ...
            <input
                ...
                class="input-filter-r w-28"  v-model.number="filterForm.priceTo"
            />
        </div>
        ...
        <div class="flex flex-wrap items-center">
            <input
                ...
                class="input-filter-l w-28" v-model="filterForm.areaFrom"
            />
            <input
                type="text" placeholder="Area to"
                class="input-filter-r w-28" v-model="filterForm.areaTo"
            />
        </div>
